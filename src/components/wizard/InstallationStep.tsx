...
import { installWordPress } from '../../utils/installation';
...
const InstallationStep: React.FC<InstallationStepProps> = ({ onNext }) => {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Installing WordPress Enterprise</h2>
          <p className="text-gray-600 mt-1">
            Please wait while we install WordPress Enterprise in your Kubernetes cluster.
          </p>
        </div>
        ...
        <div className="space-y-2 divide-y divide-gray-200 mb-6">
          ...
          {renderComponentStatus('WordPress Core Installation', status.core, <Server className="w-5 h-5" />)}
