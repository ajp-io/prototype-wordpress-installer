      ...
      <Card>
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            We'll check if your Kubernetes environment meets all the requirements for WordPress Enterprise.
          </p>
        </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm">
                  {overallStatus === 'success' ? (
                    <p>Your environment is ready for WordPress Enterprise installation.</p>
                  ) : overallStatus === 'warning' ? (
                    <p>
