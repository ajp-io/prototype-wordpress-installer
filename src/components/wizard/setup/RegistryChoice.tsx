  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-gray-600 mb-4">
        Pull images from the WordPress Enterprise registry, or have images pushed to your own private registry and pulled from there.
      </p>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        >
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-gray-900">WordPress Enterprise Registry</h3>
              <p className="text-sm text-gray-500 mt-1">
                Pull images from the WordPress Enterprise registry
              </p>
            </div>
          </div>
        </div>
